...
instance Applicative ExactlyOne where
  ...
  (<*>) (ExactlyOne fn) (ExactlyOne x) = pure.fn $ x
...
instance Applicative List where
  ...
  (<*>) fnLs ls = flatMap (\fn->map fn ls) fnLs
  -- (<*>) (fn :. fns) ls = flatten $ (map fn ls) :. (fns <*> ls) :. Nil
  -- (<*>) Nil _ = Nil
...
lift3 fn fa fb fc = (lift2 fn fa fb) <*> fc
...
lift4 fn fa fb fc fd = (lift3 fn fa fb fc) <*> fd
